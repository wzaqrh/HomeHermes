...
## ✅ youtubd 每日处理报告 — 2026-05-14

### 📡 定时任务执行
- **频道拉取**: 10/10 频道成功
- **新增视频**: 9 个加入 history
- **未处理视频池**: 201 个 → 按权重随机抽取 10 个

### ✅ 成功处理：10/10

| # | 视频 | 频道 | 时长 | 状态 |
|---|------|------|------|------|
| 1 | Pulitzer Prize Historian: You Won't Notice Until It's Too Late | The Diary Of A CEO | 108min | ✅ NotebookLM |
| 2 | Stanford study: Job losses for 22-year-olds | Alan Chen | 23min | ✅ NotebookLM |
| 3 | 当每句话都"努力不冒犯任何人"，《小红帽》会变成什么鬼样子？ | 魏知超啥书都读 | 27min | ✅ NotebookLM |
| 4 | [Boss Talks America] US Inflation Explodes Again | Boss Economics World | 1min | ✅ NotebookLM |
| 5 | 马斯克主义，政府与公司是如何共生的？ | 宏观洞察 | 38min | ✅ NotebookLM |
| 6 | 存储芯片"超级周期"还能持续多久？ | 硅谷101 | 2min | ✅ NotebookLM |
| 7 | 川普带一众大佬上门化缘，却恐吃北京凭空画的饼？ | 宏观洞察 | 28min | ✅ NotebookLM |
| 8 | 川普亲自提名，他却当着全国面拒不听令！华尔街终极Boss | Alan Chen | 20min | ✅ NotebookLM |
| 9 | [Boss Talks Canada] Unemployment rate of 6.9% | Boss Economics World | 11min | ✅ NotebookLM |
| 10 | Will mortgages in 2025 not consider credit score? | Fempire Mindset | 14min | ✅ NotebookLM |

### 📁 保存到 brain-vault 的文件

| 路径 | 大小 |
|------|------|
| `~/MyDoc/brain-vault/DiaryOfCEO_PulitzerHistorian_economy.md` | 6.6K |
| `~/MyDoc/brain-vault/AlanChen_白领失业_50%.md` | 6.7K |
| `~/MyDoc/brain-vault/魏知超_政治正确童话_小红帽.md` | 5.8K |
| `~/MyDoc/brain-vault/BossEconomics_USInflation.md` | 4.3K |
| `~/MyDoc/brain-vault/宏观洞察_马斯克主义.md` | 7.0K |
| `~/MyDoc/brain-vault/硅谷101_存储芯片超级周期.md` | 5.2K |
| `~/MyDoc/brain-vault/宏观洞察_川普化缘北京.md` | 6.0K |
| `~/MyDoc/brain-vault/AlanChen_华尔街终极Boss.md` | 5.8K |
| `~/MyDoc/brain-vault/BossEconomics_CanadaUnemployment.md` | 5.7K |
| `~/MyDoc/brain-vault/FempireMindset_mortgage2025.md` | 6.1K |

### 🗑️ todolist 已清空
所有处理完成的视频已从 todolist.txt 移除。history.json 中对应条目已标记 `processed: true` 和 `"已总结 → brain-vault (NotebookLM)"`。
