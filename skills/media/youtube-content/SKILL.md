...
## Error Handling
## Error Handling
- **Transcript disabled**: tell the user; suggest they check if subtitles are available on the video page. If still unavailable, suggest using browser tools to manually view and extract content.
