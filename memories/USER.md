...
§
用户近期任务偏好：1. 社交媒体运营（小红书）；2. 视频内容总结；3. 体育赛事舆论分析（欧冠皇马vs拜仁）；平台访问限制：海外平台（小红书、YouTube、X/Reddit）均触发IP风控/反爬拦截，需代理/换可靠网络才能正常访问；工具使用习惯：偏好使用CLI工具，部分工具需先全局安装（如xhs-cli）
§
